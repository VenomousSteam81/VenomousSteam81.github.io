...
# This fairly simple sh script should be able to make the wifi card work on a dell inspiron 1545 (in linux),
...
# http://linuxwireless.sipsolutions.net/en/users/Drivers/b43/ has the proper files which are needed
# Made by VSteam81
